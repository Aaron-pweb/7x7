        ...
        <div className="max-w-xl flex flex-col gap-4 md:gap-5">
          ...
          <div className="pt-2">
            <button
              onClick={handleStart}
              disabled={isPending}
              className="inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-primary text-on-primary font-medium text-[15px] md:text-[16px] shadow-lg hover:bg-primary/90 hover:shadow-[0_8px_30px_rgba(167,50,28,0.3)] transition-all duration-300 transform active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed"
            >
              <span>{isPending ? "Starting..." : "Begin Day 1"}</span>
              <span>→</span>
            </button>
          </div>
        </div>
