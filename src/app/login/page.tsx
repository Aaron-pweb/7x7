...
export default function LoginPage() {
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-surface-variant/20 text-on-background px-4 py-6 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-surface sm:bg-surface/95 sm:backdrop-blur-3xl border border-primary/20 p-6 sm:p-10 relative flex flex-col rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] sm:shadow-[0_20px_60px_-15px_rgba(167,50,28,0.15)] z-10 my-auto">
