...
export default function LoginPage() {
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-background text-on-background px-4 py-6 relative overflow-hidden">
      ...
      {/* 
        Mobile optimization: 
        1. Reduced padding (p-5 on mobile, p-10 on desktop).
        2. Removed backdrop-blur on mobile (can cause GPU touch-blocking on old iOS), kept on sm+. 
      */}
      <div className="w-full max-w-md bg-surface sm:bg-surface/95 sm:backdrop-blur-3xl border border-primary/10 p-5 sm:p-10 relative flex flex-col rounded-2xl shadow-[0_20px_60px_-15px_rgba(167,50,28,0.15)] z-10">
